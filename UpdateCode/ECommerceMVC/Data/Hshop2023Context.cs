...
public partial class Hshop2023Context : DbContext
{
    ...
    public virtual DbSet<CartItemDb> CartItems { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-M2T9566J\\SQLEXPRESS;Initial Catalog=Hshop2023;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CartItemDb>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__CartItem__3214EC0775E791D3");

            entity.Property(e => e.Hinh).HasMaxLength(255);
            entity.Property(e => e.MaKh).HasMaxLength(50);
            entity.Property(e => e.NgàyTạo)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime");
